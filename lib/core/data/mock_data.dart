    ...
    KpiCategory(
      ...
      indicators: const [
        KpiIndicator(
          ...
          changeText: '↗ 15%',
          isPositive: true,
          source: 'DHIS2, FP Registers 2025',
        ...
        KpiIndicator(
          ...
          isPositive: true,
          source: 'DHIS2, ANC Registers 2025',
        ...
        KpiIndicator(
          ...
          changeText: '↗ 2%',
          isPositive: false,
          source: 'DHIS2, PAC Registers 2025',
        ...
        KpiIndicator(
          ...
          isPositive: true,
          sdgTag: 'SDG 3.b.1',
          source: 'DHIS2, EPI Registers 2025',
        ...
        KpiIndicator(
          ...
          changeText: '↗ 3%',
          isPositive: true,
          source: 'DHIS2, Nutrition Registers 2025',
        ...
        KpiIndicator(
          ...
          changeText: '↗ 1.2%',
          isPositive: true,
          source: 'DHIS2, Maternity Registers 2025',
    ...
    KpiCategory(
      ...
      indicators: const [
        ...
        KpiIndicator(
          ...
          changeText: '↓ 2%',
          isPositive: false,
          source: 'DHIS2, General Register 2025',
        ...
        KpiIndicator(
          ...
          changeText: '↗ 6%',
          isPositive: true,
          source: 'DHIS2, Referral Registers 2025',
        ...
        KpiIndicator(
          ...
          changeText: '↓ 1.8%',
          isPositive: true,
          source: 'DHIS2, Stock Reports 2025',
